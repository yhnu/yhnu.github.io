---
title: "PyCharm 2019.1.1 破解"
description: "Python 环境破解"
date: "2020-1-2"
categories:
  - "Python"
tags:
...
![image-20200103152952397](PyCharm_Crack/image-20200103152952397.png)

### 0x03 修改`xx.vmoptions` 文件，加上 `-javaagent:C:\Program Files\JetBrains\PyCharm 2019.1.1\bin\jetbrains-agent.jar`

[jetbrains-agent下载地址](http://blog.alphaz.cn/files/jetbrains-agent.jar)

### 0x04 激活

启动Pycharm，并激活，如图：选择最后一种License server激活方式，地址填入：[http://jetbrains-license-server](http://jetbrains-license-server/) （应该会自动填上），或者点击按钮：”Discover Server”来自动填充地址，完成激活
